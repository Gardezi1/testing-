Template.inviteAdvocate.events({
  'click #invite-advocate-by-email': function (e) {
    ...
    if(mail){
      ...
      sAlert.error('Please enter email.', {effect: 'genie', position: 'top-right', timeout: 5000, onRouteClose: false, stack: false, offset: '80px'});
    }    
  },
  'click #invite-advocate-by-phone': function (e) {
    ...
    if(phone){
      ...
      sAlert.error('Please enter phone.', {effect: 'genie', position: 'top-right', timeout: 5000, onRouteClose: false, stack: false, offset: '80px'});
    }
  }
